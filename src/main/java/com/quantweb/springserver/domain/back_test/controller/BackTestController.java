...
public class BackTestController {
  ...
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        ...
        description = "OK, 성공"),
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "BACKTEST400",
        description = "백테스트 이름이 중복되었습니다.",
        content = @Content(schema = @Schema(implementation = EntityResponse.class))),
  })
  @Authenticated
  ...
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        ...
        description = "OK, 성공"),
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "BACKTEST404",
        description = "백테스트가 존재하지 않습니다.",
        content = @Content(schema = @Schema(implementation = EntityResponse.class))),
  })
  @Parameters({
    @Parameter(name = "backtestId", description = "조회할 백테스트 Id"),
  })
  public ResponseEntity<BackTestResponseDto.GetBackTestDto> getResultDetails(
  ...
  @Authenticated
  public ResponseEntity<StockResponseDto> getInvestmentSectors(
      @PathVariable("backtestId") Long backtestId) {
