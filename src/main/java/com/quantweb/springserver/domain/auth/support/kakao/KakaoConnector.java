...
public class KakaoConnector {
  ...
  public ResponseEntity<KakaoUserResponse> requestKakaoUserInfo(String code, String redirectUrl) {
    ...
    return REST_TEMPLATE.exchange(
        provider.getUserInfoUrl(), HttpMethod.GET, entity, KakaoUserResponse.class);
  }
  ...
  private String requestAccessToken(String code, String redirectUrl) {
    ...
    ResponseEntity<KakaoTokenResponse> response =
        REST_TEMPLATE.postForEntity(provider.getAccessTokenUrl(), entity, KakaoTokenResponse.class);
