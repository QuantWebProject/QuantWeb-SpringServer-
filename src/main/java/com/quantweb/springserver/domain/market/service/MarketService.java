...
public interface MarketService {
    ...
    //마켓 전략 백 테스트 최신순 조회
    MarketPagingResponse <MarketSummaryResponse> inquiryMarketBackTestByCreatedAt(Long userId, int page, int size);
    //마켓 전략 모의 투자 최신순 조회
    MarketPagingResponse <MarketSummaryResponse> inquiryMarketInvestmentSimulationByCreatedAt(Long userId,int page, int size);
    //마켓 전략 백 테스트 추천순 조회
    MarketPagingResponse <MarketSummaryResponse> inquiryMarketBackTestByRecommend(Long userId,int page, int size);
    //마켓 전략 모의 투자 추천순 조회
    MarketPagingResponse <MarketSummaryResponse> inquiryMarketInvestmentSimulationByRecommend(Long userId,int page, int size);
    // 마켓 전략 등록 되어 있는 백 테스트 검색
    MarketPagingResponse <MarketSummaryResponse> inquiryMarketBackTestByKeyword(Long userId,String keyword, int page, int size);
    // 마켓 전략 등록 되어 있는 모의 투자 검색
    MarketPagingResponse <MarketSummaryResponse> inquiryMarketInvestmentSimulationByKeyword(Long userId,String keyword, int page, int size);
    // 마켓 좋아요 누르기
