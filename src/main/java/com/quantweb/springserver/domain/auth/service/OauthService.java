...
import com.quantweb.springserver.domain.auth.support.RandomNickName;
import com.quantweb.springserver.domain.auth.support.google.GoogleConnector;
import com.quantweb.springserver.domain.auth.support.google.GoogleProvider;
import com.quantweb.springserver.domain.auth.support.google.dto.GoogleUserResponse;
import com.quantweb.springserver.domain.auth.support.kakao.KakaoConnector;
import com.quantweb.springserver.domain.auth.support.kakao.KakaoProvider;
import com.quantweb.springserver.domain.auth.support.kakao.dto.KakaoUserResponse;
import com.quantweb.springserver.domain.auth.support.naver.NaverConnector;
import com.quantweb.springserver.domain.auth.support.naver.NaverProvider;
import com.quantweb.springserver.domain.auth.support.naver.dto.NaverUserResponse;
import com.quantweb.springserver.domain.user.entity.Oauth;
import com.quantweb.springserver.domain.user.entity.OauthRepository;
  ...
  private User checkAndSaveUser(String type, String code, String redirectUrl) {
    ...
    if (Objects.equals(type, "google")) {
      GoogleUserResponse response =
          googleConnector.requestGoogleUserInfo(code, redirectUrl).getBody();
    ...
    if (Objects.equals(type, "naver")) {
      NaverUserResponse response = naverConnector.requestNaverUserInfo(code, redirectUrl).getBody();
